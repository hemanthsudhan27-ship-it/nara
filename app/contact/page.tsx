          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="space-y-3 pt-4 border-t border-white/10">
                ...
                <div className="space-y-3 text-sm text-neutral-300">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span>@teamnara.in (Direct Message)</span>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-brand-orange text-white space-y-3 shadow-xl">
                <h4 className="text-2xl font-headline font-black uppercase">
                  Ready to Register?
                </h4>
            ...
            <div className="lg:col-span-7 bg-[#1C1C1C] border border-white/10 rounded-2xl sm:rounded-3xl p-5 sm:p-10 shadow-2xl">
              ...
              <h3 className="text-xl sm:text-3xl font-black font-headline uppercase text-white mt-1 mb-5 sm:mb-6">
                ASK US ANYTHING
              </h3>
              ...
              {inquirySent ? (
                <div className="text-center py-10 sm:py-12 space-y-4">
                  ...
                  <h4 className="text-xl sm:text-2xl font-headline font-bold uppercase text-white">
                    Message Received!
                  </h4>

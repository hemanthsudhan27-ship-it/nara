        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl space-y-4">
            ...
            <p className="text-base sm:text-xl text-neutral-300 font-normal leading-relaxed pt-2">
              ...
              acrobatics. Explore the 5 pillars of the NARA movement method in Calicut, Kerala.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
          {DISCIPLINES_DETAILED.map((d, index) => {
            ...
            return (
              ...
              >
                {/* Visual Image with Rich Alt Text */}
                <div
                ...
                >
                  <div className="relative aspect-[16/10] sm:aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl border-2 border-white/15 bg-neutral-900 group">
                    <Image
                      src={d.image}
                      alt={`${d.title} - ${d.subtitle} coached by Team NARA in Calicut, Kerala`}
                      fill
                ...
                >
                  ...
                  <div className="pt-2 sm:pt-4 flex flex-wrap items-center gap-3">
                    <button
                      ...
                      className="group inline-flex items-center justify-center gap-2.5 px-6 py-3.5 sm:py-3 bg-brand-orange hover:bg-brand-orange-hover text-white font-bold text-xs uppercase tracking-wider rounded-xl transition shadow-lg shadow-brand-orange/20 active:scale-98"
                    >
